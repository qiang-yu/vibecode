...
class VllmParsedLLM(BasePipelineElement):
    ...
    def __init__(
        ...
        # VLLM  base_model and lora_model
        self.base_model = os.getenv("VLLM_Base_Model", None)
        self.lora_model = os.getenv("VLLM_Lora_Model", None)
